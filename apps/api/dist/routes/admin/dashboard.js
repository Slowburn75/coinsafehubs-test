...
export const dashboardRouter = {
    getStats: implement(adminContract.getStats).handler(async () => {
        try {
            ...
            const [totalUsers, activeUsersLoginCount, frozenAccounts, pendingKycCount, totalDeposits, totalWithdrawals, activeInvestments, paidRoi, pendingWithdrawals, pendingDeposits] = await Promise.all([
