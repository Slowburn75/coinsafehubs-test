...
export const dashboardRouter = {
    getStats: implement(adminContract.getStats).handler(async () => {
        try {
            ...
            const [totalUsers, activeUsers30d, frozenAccounts, pendingKycCount, depositsAllTime, withdrawalsAllTime, activeInvestments, pendingWithdrawals, pendingDeposits] = await Promise.all([
                prisma.user.count(),
